...
<head>
	...
	<title>@yield('title','ProTechMaster Admin')</title>
	
	{{ HTML::style('assets/plugins/adminTemp/css/plugins/pace/pace.css') }}
	{{ HTML::script('assets/plugins/adminTemp/js/plugins/pace/pace.js') }}

	{{ HTML::style('assets/plugins/adminTemp/css/plugins/bootstrap/css/bootstrap.min.css') }}
	...
	{{ HTML::style('assets/plugins/adminTemp/icons/font-awesome/css/font-awesome.min.css') }}

	{{ HTML::style('assets/plugins/adminTemp/css/plugins/messenger/messenger.css') }}
    {{ HTML::style('assets/plugins/adminTemp/css/plugins/messenger/messenger-theme-flat.css') }}
    {{ HTML::style('assets/plugins/adminTemp/css/plugins/daterangepicker/daterangepicker-bs3.css') }}
    {{ HTML::style('assets/plugins/adminTemp/css/plugins/morris/morris.css') }}
    {{ HTML::style('assets/plugins/adminTemp/css/plugins/jvectormap/jquery-jvectormap-1.2.2.css') }}
    {{ HTML::style('assets/plugins/adminTemp/css/plugins/datatables/datatables.css') }}

	
	{{ HTML::style('assets/plugins/adminTemp/css/style.css') }}
    {{ HTML::style('assets/plugins/adminTemp/css/plugins.css') }}

    {{ HTML::style('assets/plugins/adminTemp/css/demo.css') }}

    <!--[if lt IE 9]>
     {{ HTML::script('assets/plugins/adminTemp/js/html5shiv.js') }}
     {{ HTML::script('assets/plugins/adminTemp/js/respond.min.js') }}
    <![endif]-->
...
<body>
        ...
        <nav class="navbar-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <div class="navbar-brand">
                    <a href="index.html">
                        <!-- <img src="/assets/img/sm-logo.png" data-1x="img/flex-admin-logo@1x.png" data-2x="img/flex-admin-logo@2x.png" class="hisrc img-responsive" alt=""> -->
                        ProTechMaster
                    </a>
                </div>
            </div>
            ...
            <div class="navbar-collapse sidebar-collapse collapse">
                <ul id="side" class="nav navbar-nav side-nav">
                    ...
                    <li class="side-user hidden-xs">
                    	{{HTML::image('/assets/plugins/adminTemp/img/profile-pic.jpg', 'Profile Picture',array('class'=>'img-circle'))}}
                        <p class="welcome">
    ...
    {{ HTML::script('assets/plugins/adminTemp/js/plugins/bootstrap/bootstrap.min.js') }}
    {{ HTML::script('assets/plugins/adminTemp/js/plugins/slimscroll/jquery.slimscroll.min.js') }}
    {{ HTML::script('assets/plugins/adminTemp/js/plugins/popupoverlay/jquery.popupoverlay.js') }}
    {{ HTML::script('assets/plugins/adminTemp/js/plugins/popupoverlay/defaults.js') }}

    <!-- Logout Notification Box -->
    <div id="logout">
        <div class="logout-message">
        	{{HTML::image('assets/plugins/adminTemp/img/profile-pic.jpg', 'Profile Picture',array('class'=>'img-circle img-logout'))}}
    ...
    <!-- Logout Notification jQuery -->
     {{ HTML::script('assets/plugins/adminTemp/js/plugins/popupoverlay/logout.js') }}
    <!-- HISRC Retina Images -->
     {{ HTML::script('assets/plugins/adminTemp/js/plugins/hisrc/hisrc.js') }}

    <!-- PAGE LEVEL PLUGIN SCRIPTS -->
    <!-- HubSpot Messenger -->
     {{ HTML::script('assets/plugins/adminTemp/js/plugins/messenger/messenger.min.js') }}
     {{ HTML::script('assets/plugins/adminTemp/js/plugins/messenger/messenger-theme-flat.js') }}
    <!-- Date Range Picker -->
     {{ HTML::script('assets/plugins/adminTemp/js/plugins/daterangepicker/moment.js') }}
     {{ HTML::script('assets/plugins/adminTemp/js/plugins/daterangepicker/daterangepicker.js') }}
    <!-- Morris Charts -->
     {{ HTML::script('assets/plugins/adminTemp/js/plugins/morris/raphael-2.1.0.min.js') }}
     {{ HTML::script('assets/plugins/adminTemp/js/plugins/morris/morris.js') }}
    <!-- Flot Charts -->
     {{ HTML::script('assets/plugins/adminTemp/js/plugins/flot/jquery.flot.js') }}
     {{ HTML::script('assets/plugins/adminTemp/js/plugins/flot/jquery.flot.resize.js') }}
    <!-- Sparkline Charts -->
     {{ HTML::script('assets/plugins/adminTemp/js/plugins/sparkline/jquery.sparkline.min.js') }}
    <!-- Moment.js -->
     {{ HTML::script('assets/plugins/adminTemp/js/plugins/moment/moment.min.js') }}
    <!-- jQuery Vector Map -->
     {{ HTML::script('assets/plugins/adminTemp/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js') }}
     {{ HTML::script('assets/plugins/adminTemp/js/plugins/jvectormap/maps/jquery-jvectormap-world-mill-en.js') }}
     {{ HTML::script('assets/plugins/adminTemp/js/demo/map-demo-data.js') }}
    <!-- Easy Pie Chart -->
     {{ HTML::script('assets/plugins/adminTemp/js/plugins/easypiechart/jquery.easypiechart.min.js') }}
    <!-- DataTables -->
     {{ HTML::script('assets/plugins/adminTemp/js/plugins/datatables/jquery.dataTables.js') }}
     {{ HTML::script('assets/plugins/adminTemp/js/plugins/datatables/datatables-bs3.js') }}

    <!-- THEME SCRIPTS -->
     {{ HTML::script('assets/plugins/adminTemp/js/flex.js') }}
     {{ HTML::script('assets/plugins/adminTemp/js/demo/dashboard-demo.js') }}
